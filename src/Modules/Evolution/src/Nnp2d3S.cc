...
double evolution::rhs_Nnp2d3_FS(double t, const double y[], double par[2], int i)
{
  ...
  case 3 : 
    return((-((par[0]*par[1]*(y[0] - y[9]))/pow(pow(y[0] - y[9],2) + pow(y[1] - y[10],2) + pow(y[2] - y[11],2),1.5)) + (par[0]*par[1]*(-y[0] + y[9]))/pow(pow(-y[0] + y[9],2) + pow(-y[1] + y[10],2) + pow(-y[2] + y[11],2),1.5))/2.);
    break;

  case 4 : 
    return((-((par[0]*par[1]*(y[1] - y[10]))/pow(pow(y[0] - y[9],2) + pow(y[1] - y[10],2) + pow(y[2] - y[11],2),1.5)) + (par[0]*par[1]*(-y[1] + y[10]))/pow(pow(-y[0] + y[9],2) + pow(-y[1] + y[10],2) + pow(-y[2] + y[11],2),1.5))/2.);
    break;

  case 5 : 
    return((-((par[0]*par[1]*(y[2] - y[11]))/pow(pow(y[0] - y[9],2) + pow(y[1] - y[10],2) + pow(y[2] - y[11],2),1.5)) + (par[0]*par[1]*(-y[2] + y[11]))/pow(pow(-y[0] + y[9],2) + pow(-y[1] + y[10],2) + pow(-y[2] + y[11],2),1.5))/2.);
    break;
...
double evolution::jac_Nnp2d3_FaS(double t, const double y[], double par[2], int i, int j)
{
